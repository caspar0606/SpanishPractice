...
def exercise_selection(current_session: CurrentSession):
    ...
    exercise_type = exercise_type_selection(current_session)

    difficulty_level = difficulty_selection(current_session)
...
def focus_selection(current_session: CurrentSession, difficulty_level: DifficultyLevels):
    while True:
        ...
        if weak_or_preferences == "weak":
                ...
                focus_tenses, \
                focus_grammar, \
                focus_topics = weak_areas(difficulty_level, current_session.user)
                break
